...
from advent_of_code.year_2023.day_18.star_1_00_pygame_failure.algo import (
    Plan,
    parse,
    print_area,
)
...
def algo(text: str) -> int:
    ...
    image.save(CUR_DIR / "plan_colored.png")
    print_area(area)
